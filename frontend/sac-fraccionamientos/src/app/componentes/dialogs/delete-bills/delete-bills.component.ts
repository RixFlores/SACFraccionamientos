...
@Component({
  ...
  <div style="padding:40px;">
    <h3 mat-dialog-title>Eliminar gasto:</h3>
    <div mat-dialog-content>
      <p>¿Seguro que deseas eliminar el gasto: <b> {{ data.bill.description }} </b> ?</p>
    </div>
...
export class DeleteBillsComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<DeleteBillsComponent>,
