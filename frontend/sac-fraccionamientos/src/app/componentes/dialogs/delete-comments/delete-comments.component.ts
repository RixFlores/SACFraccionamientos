...
@Component({
  ...
  <div style="padding:40px;">
    <h3 mat-dialog-title>Eliminar comentario:</h3>
    <div mat-dialog-content>
      <p>¿Seguro que deseas eliminar el comentario: <b> {{ data.comment.Title }} </b> ?</p>
    </div>
...
export class DeleteCommentsComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<DeleteCommentsComponent>,
